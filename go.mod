...
require (
	...
	github.com/apache/answer-plugins/connector-passkey v0.0.0-00010101000000-000000000000
...
replace github.com/apache/answer-plugins/connector-passkey => ./ui/src/plugins/connector-passkey
